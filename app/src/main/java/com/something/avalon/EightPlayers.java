...
public class EightPlayers extends AppCompatActivity {
    ...
    Character cap;
    int cap_num;
    private int[] flow = new int[]{3, 4, 4, 5, 5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eight_players);
        ...
        final CheckBox c1 = (CheckBox) findViewById(R.id.checkBox81);
        c1.setText(characters.get(0).getName());
        final CheckBox c2 = (CheckBox) findViewById(R.id.checkBox82);
        c2.setText(characters.get(1).getName());
        final CheckBox c3 = (CheckBox) findViewById(R.id.checkBox83);
        c3.setText(characters.get(2).getName());
        final CheckBox c4 = (CheckBox) findViewById(R.id.checkBox84);
        ...
        c8.setText(characters.get(7).getName());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(c8.isChecked()){
                    check += 1;
                    onMission.add(characters.get(7));
                }
                if(check == flow[success+fail]){
                    AlertDialog.Builder builder = new AlertDialog.Builder(EightPlayers.this);
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent i = new Intent(EightPlayers.this, Vote.class);
                            i.putExtra("index", 0);
                    ...
                    builder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            change += 1;
                            if (change != 5) {
                                Intent intent = new Intent(EightPlayers.this, EightPlayers.class);
                                ...
                                if (fail< 2) {
                                    ...
                                    Intent i = new Intent(EightPlayers.this, GameOver.class);
