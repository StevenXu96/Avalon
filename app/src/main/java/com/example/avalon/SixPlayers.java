...
public class SixPlayers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheckBox c1 = (CheckBox) findViewById(R.id.checkBox61);
        c1.setText(characters.get(0).getName());
        final CheckBox c2 = (CheckBox) findViewById(R.id.checkBox62);
        c2.setText(characters.get(1).getName());
        final CheckBox c3 = (CheckBox) findViewById(R.id.checkBox63);
        c3.setText(characters.get(2).getName());
        final CheckBox c4 = (CheckBox) findViewById(R.id.checkBox64);
                ...
                if(check == flow[success+fail]){
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent i = new Intent(SixPlayers.this, Vote.class);
                            i.putExtra("index", 0);
